...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderPengalaman,
            //'filterModel' => $searchModelPengalaman,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='pengalaman-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_teknis_pengalaman_id.'#detail';
                        return $url;
                    }
                  }
                ],
