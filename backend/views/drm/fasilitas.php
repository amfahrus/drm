...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderFasilitas,
            //'filterModel' => $searchModelFasilitas,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='fasilitas-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_teknis_alat_id.'#detail';
                        return $url;
                    }
                  }
                ],
