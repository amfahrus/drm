        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    'attribute'=>'lampiran',
                    'format'=>'raw',
                    'value'=> $modelPendukung->lampiran ? Html::a('download', Url::to((isset($_SERVER["HTTPS"]) ? "https://" : "http://").Yii::$app->params['ipfrontend'].'/uploads/'.$modelPendukung->lampiran, true)) : '',
                ],
            ],
        ]) ?>
