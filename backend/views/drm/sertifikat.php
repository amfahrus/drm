...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderSertifikat,
            //'filterModel' => $searchModelSertifikat,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='sertifikat-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_teknis_sertifikat_id.'#detail';
                        return $url;
                    }
                  }
                ],
