        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    'attribute'=>'lampiran',
                    'format'=>'raw',
                    'value'=> $modelBarang->lampiran ? Html::img(Url::to((isset($_SERVER["HTTPS"]) ? "https://" : "http://").Yii::$app->params['ipfrontend'].'/uploads/'.$modelBarang->lampiran, true),['class' => 'img-responsive img-thumbnail']) : '',
                ],
            ],
        ]) ?>
