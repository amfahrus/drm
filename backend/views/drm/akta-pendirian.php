...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderAktaPendirian,
            //'filterModel' => $searchModelAktaPendirian,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='akta-pendirian-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_legal_akta_id.'#detail';
                        return $url;
                    }
                  }
                ],
