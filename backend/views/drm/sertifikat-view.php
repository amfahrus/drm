        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    'attribute'=>'lampiran',
                    'format'=>'raw',
                    'value'=> $modelSertifikat->lampiran ? Html::a('download', Url::to((isset($_SERVER["HTTPS"]) ? "https://" : "http://").Yii::$app->params['ipfrontend'].'/uploads/'.$modelSertifikat->lampiran, true)) : '',
                ],
            ],
        ]) ?>
