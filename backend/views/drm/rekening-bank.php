...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderRekeningBank,
            //'filterModel' => $searchModelRekeningBank,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='rekening-bank-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_keu_rekening_id.'#detail';
                        return $url;
                    }
                  }
                ],
