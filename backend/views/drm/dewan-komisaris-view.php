        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    'attribute'=>'lampiran',
                    'format'=>'raw',
                    'value'=> $modelDewanKomisaris->lampiran ? Html::a('download', Url::to((isset($_SERVER["HTTPS"]) ? "https://" : "http://").Yii::$app->params['ipfrontend'].'/uploads/'.$modelDewanKomisaris->lampiran, true)) : '',
                ],
            ],
        ]) ?>
