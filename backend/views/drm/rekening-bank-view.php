        ...
        <?= DetailView::widget([
            ...
            'attributes' => [
                ...
                [
                    'attribute'=>'lampiran',
                    'format'=>'raw',
                    'value'=> $modelRekeningBank->lampiran ? Html::a('download', Url::to((isset($_SERVER["HTTPS"]) ? "https://" : "http://").Yii::$app->params['ipfrontend'].'/uploads/'.$modelRekeningBank->lampiran, true)) : '',
                ],
            ],
        ]) ?>
