...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderDomisiliPerusahaan,
            //'filterModel' => $searchModelDomisiliPerusahaan,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='domisili-perusahaan-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_legal_domisili_id.'#detail';
                        return $url;
                    }
                  }
                ],
