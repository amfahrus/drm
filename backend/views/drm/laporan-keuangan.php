...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderLaporanKeuangan,
            //'filterModel' => $searchModelLaporanKeuangan,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='laporan-keuangan-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_keu_laporan_id.'#detail';
                        return $url;
                    }
                  }
                ],
