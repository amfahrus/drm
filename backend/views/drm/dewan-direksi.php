...
<div id="detail">
    ...
    <div class="panel panel-info">
      <div class="panel-body">
        ...
        <?= GridView::widget([
            'dataProvider' => $dataProviderDewanDireksi,
            //'filterModel' => $searchModelDewanDireksi,
            'columns' => [
                ['class' => 'yii\grid\SerialColumn'],
                ...
                [
                  ...
                  'urlCreator' => function ($action, $model, $key, $index) {
                    if ($action === 'view-drm') {
                        $url ='dewan-direksi-view?id='.$model->t_vendor_company_id.'&sid='.$model->t_vendor_kepengurusan_id.'#detail';
                        return $url;
                    }
                  }
                ],
