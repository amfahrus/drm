...
/**
 * TVendorSdmPendukungSearch represents the model behind the search form about `frontend\models\TVendorSdm`.
 */
class TVendorSdmPendukungSearch extends TVendorSdm
{
    /**
     * @inheritdoc
     */
