...
$this->params['breadcrumbs'][] = ['label' => 'Barang', 'url' => [Yii::$app->controller->id.'/index']];
...
<div class="panel panel-default">
  <div class="panel-heading">
      <h1>Tambah Harga Barang</h1>
  </div>
  <div class="panel-body tvendor-teknis-komoditi-create">
