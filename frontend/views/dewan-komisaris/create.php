...
$this->title = 'Tambah Dewan Komisaris';
...
$this->params['breadcrumbs'][] = ['label' => 'Dewan Komisaris', 'url' => [Yii::$app->controller->id.'/index']];
...
<div class="panel panel-default">
  ...
  <div class="panel-body tvendor-kepengurusan-create">
