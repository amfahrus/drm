...
<div class="panel panel-default">
  ...
  <div class="panel-body tvendor-legal-akta-view">
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->t_vendor_legal_akta_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->t_vendor_legal_akta_id], [
