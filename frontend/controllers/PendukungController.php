...
use frontend\models\TVendorSdmPendukungSearch;
...
/**
 * PendukungController implements the CRUD actions for TVendorSdm model.
 */
class PendukungController extends Controller
{
    ...
    {
        $searchModel = new TVendorSdmPendukungSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->lampiran = preg_replace('/[^A-Za-z0-9\-]/', '_', Yii::$app->user->identity->id.'_tenaga_ahli_pendukung_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension;
            $model->create_user = Yii::$app->user->identity->id;
            $model->update_user = Yii::$app->user->identity->id;
            $model->save();
            $model->uploadFile->saveAs($path . preg_replace('/[^A-Za-z0-9\-]/', '_',  Yii::$app->user->identity->id.'_tenaga_ahli_pendukung_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension);
