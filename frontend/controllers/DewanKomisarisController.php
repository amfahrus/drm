...
use frontend\models\TDewanKomisarisSearch;
...
/**
 * DewanKomisarisController implements the CRUD actions for TVendorKepengurusan model.
 */
class DewanKomisarisController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new TDewanKomisarisSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->lampiran = preg_replace('/[^A-Za-z0-9\-]/', '_', Yii::$app->user->identity->id.'_dewan_komisaris_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension;
            $model->create_user = Yii::$app->user->identity->id;
            $model->update_user = Yii::$app->user->identity->id;
            $model->save();
            $model->uploadFile->saveAs($path . preg_replace('/[^A-Za-z0-9\-]/', '_',  Yii::$app->user->identity->id.'_dewan_komisaris_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension);
