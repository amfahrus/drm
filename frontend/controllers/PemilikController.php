...
use frontend\models\TPemilikSearch;
...
/**
 * PemilikController implements the CRUD actions for TVendorKepengurusan model.
 */
class PemilikController extends Controller
{
    ...
    {
        $searchModel = new TPemilikSearch();
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post())) {
            ...
            $model->lampiran = preg_replace('/[^A-Za-z0-9\-]/', '_', Yii::$app->user->identity->id.'_pemilik_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension;
            $model->create_user = Yii::$app->user->identity->id;
            $model->update_user = Yii::$app->user->identity->id;
            $model->save();
            $model->uploadFile->saveAs($path . preg_replace('/[^A-Za-z0-9\-]/', '_',  Yii::$app->user->identity->id.'_pemilik_'.date('d m y h:i:s')) . '.' . $model->uploadFile->extension);
