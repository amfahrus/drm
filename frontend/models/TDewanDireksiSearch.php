...
/**
 * TDewanDireksiSearch represents the model behind the search form about `frontend\models\TVendorKepengurusan`.
 */
class TDewanDireksiSearch extends TVendorKepengurusan
{
    /**
     * @inheritdoc
     */
